...
//    public static final String JUN_CHEF_MEMBER_BASE_URL = "http://10.0.2.2:8081/jun-chef/v1/members";
//    public static final String JUN_CHEF_RECIPE_BASE_URL = "http://10.0.2.2:8081/jun-chef/v1/recipe";
//    public static final String JUN_CHEF_HISTORY_BASE_URL = "http://10.0.2.2:8081/jun-chef/v1/history";
}